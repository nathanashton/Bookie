namespace Bookie.Data
{
    ...
    public class Context : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //Publishers
            modelBuilder.Entity<Book>()
                .HasMany<Publisher>(s => s.Publishers)
                .WithOptional(c => c.Book)
